...
public class TenancyController {
    ...
    public ResponseEntity getByUserId(@PathVariable("id") Integer id) throws Exception {
        List<Tenancy> tenancyList = tenancyService.findByUserId(id);
        return ResponseEntity.status(HttpStatus.OK).body(new SuccessResponse<>("Success get tenancy by user id", tenancyList));
    }
